function data=rmDBS(data,params,HampelParams,plt)
% removes significant sine waves from data (continuous data).
%
% Usage: data=rmDBS(data,params,HampelParams,plt)
%
%  Inputs:  
...
%                   'adaptive': Use an experimental adaptive Hampel filter. 
%
%       plt         (y/n for plot and no plot respectively)
%
%  Outputs: 
%       data        (data with DBS artifact removed)
%
...
[datafit,Amps,freqs,Indx]=fitDBS(data,params,HampelParams);
datan=data-datafit;
