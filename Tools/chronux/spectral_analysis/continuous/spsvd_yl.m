function [sv,sp,fm,f] = spsvd_yl(data,params,mdkp)
...
%
% Outputs:
% sv sp fm f : singular values, space modes, frequency modes, freq grid
%
% 2012/08/25 yl: fixes bug in Fourier projection, also returns frequency
% grid
...
J = mtfftc(data,tapers,nfft,Fs);   % perform fft to project into Fourier basis
J=J(findx,:,:);
...
%     proj=tapers.*exp(-f(j)*tvec);    % this doesn't work
