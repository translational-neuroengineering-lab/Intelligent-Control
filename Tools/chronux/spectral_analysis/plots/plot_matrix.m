...
if nargin < 5;
   imagesc(t,f,X');axis xy; ; 
else
   subplot(311); imagesc(t,f,squeeze(Xerr(1,:,:))'); axis xy; ; title('Lower confidence');
   subplot(312); imagesc(t,f,X'); title('X');axis xy; ;
   subplot(313); imagesc(t,f,squeeze(Xerr(2,:,:))'); axis xy; ; title('Upper confidence');
end;
